      ...
      <div>
        <div class="d-flex px-3 mb-3">
          ...
          <div class="d-flex flex-column align-items-start ms-5">
            ...
            <div class="my-2" id="overview">
              <h4 style="color:black">줄거리: <a :href="movie.overview">네이버 줄거리 검색</a></h4>
            </div>
...
export default {
  ...
  created(){
    axios({
      url:'http://127.0.0.1:8000/memovies/movies/naver/'+this.$route.params.movieid,
      method:'get',
    })
      .then(res=>{
